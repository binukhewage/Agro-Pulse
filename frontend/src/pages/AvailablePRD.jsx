...
const AvailablePRD = () => {
  ...
  // Sri Lankan districts and divisions
  const districts = [
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Available Crop Production
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Please fill out the form below to submit the details of the crops supplied from your division. 
            This helps us keep track of the quantity, types, and order status of crops for efficient distribution. 
            Ensure that all fields are filled accurately to process your order smoothly.
            <br />
