      ...
      >
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-6">
              <div>
                ...
                <p className="text-white/90 text-sm">Access your AgroPulse account</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-3/5 p-6 sm:p-8 flex flex-col justify-center">
            <Link 
            to="/" 
            className="absolute top-3 left-93 z-10 flex items-center text-[#478451] hover:text-[#3a6d43] transition-colors duration-200"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center text-xs text-gray-600 mt-4">
                ...
                <Link to="/buyersignup" className="text-[#478451] hover:underline font-medium">
                  Sign up
                </Link>
              </div>
            </form>
